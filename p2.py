...
nl=int((100-position[i])/2)
print("The number of steps taken to the left in our first hypothesis is %s.Therefore, the number of steps taken to the right is %s." %(nl, (100-nl)))
