...
P=np.log((math.factorial(n_steps))*((step_prob)**50)*((1-step_prob)**50))/(((math.factorial(50)))*(math.factorial(50)))
print("The likelihood for our first hyposthesis is %s" %(P))
#print(steps)
#print(position)
# Plot it!
...
P2=np.log((math.factorial(n_steps2))*((step_prob2)**20)*((1-step_prob2)**80))/(((math.factorial(20)))*(math.factorial(80)))
print("The likelihood for our second hypothesis is %s" %(P2))
#print(steps)
#print(position)
# Plot it!
